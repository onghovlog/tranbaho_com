...
const APP_DATA = {
  "profile": {
    ...
    "zalo": "https://zalo.me/0918326706",
    "messenger": "https://m.me/baho.tran",
  ...
  "courses": [
    {
      ...
      "slug": "thiet-ke-chuyen-nghiep",
      "image": "assets/images/courses/khoahoc_design.png",
      "label": "Học Online",
      "format": "Google Meet",
      "description": "Học cách xây dựng sản phẩm thiết kế chuyên nghiệp từ chỉnh sửa hình ảnh, thiết kế vector đến ứng dụng AI để tăng tốc quy trình sáng tạo.",
      "skills": [
        "Adobe Photoshop",
        "Adobe Illustrator",
        "AI hỗ trợ thiết kế"
    ...
    {
      "id": 2,
      "title": "Editor chuyên nghiệp",
      "slug": "editor-chuyen-nghiep",
      "image": "assets/images/courses/khoahoc_edit.png",
      "label": "Học Online",
      "format": "Google Meet",
      "description": "Phát triển kỹ năng dựng video, xử lý hình ảnh chuyển động, hiệu ứng và sản xuất nội dung ngắn phục vụ TikTok, Reels, YouTube và truyền thông.",
      "skills": [
        "Adobe Premiere",
        "Adobe After Effects",
        "CapCut"
    ...
    },
    {
      ...
      "slug": "ui-ux",
      "image": "assets/images/courses/khoahoc_uiux.png",
      "label": "Học Online",
      "format": "Google Meet",
      "description": "Học quy trình thiết kế giao diện website và ứng dụng, từ tư duy trải nghiệm người dùng đến xây dựng prototype bằng Figma và AI.",
      "skills": [
        "Tư duy thiết kế",
        "UI/UX cơ bản",
        "Figma",
    ...
    {
      "id": 4,
      "title": "Thiết kế thực chiến",
      "slug": "thiet-ke-thuc-chien",
      "image": "assets/images/courses/khoahoc_event.png",
      "label": "Học Online",
      "format": "Google Meet",
      "description": "Tập trung vào các bài tập thực tế như banner, poster, hình ảnh sự kiện và bộ nhận diện nội dung dành cho Facebook, TikTok và các kênh Social Media.",
      "skills": [
        "Thiết kế hình ảnh sự kiện",
        "Thiết kế truyền thông",
        "Xây dựng thương hiệu Social",
        "Thiết kế nội dung kinh doanh"
      ],
      "active": true
    },
    {
      ...
      "title": "AI cơ bản",
      "slug": "ai-co-ban",
      "image": "assets/images/courses/khoahoc_ai.png",
      "label": "Học Online",
      "format": "Google Meet",
      "description": "Làm quen với các công cụ AI thiết thực để tạo nội dung, slide, hình ảnh và video phục vụ công việc, học tập hoặc kinh doanh.",
      "skills": [
        "Công cụ AI phổ biến",
        "AI tạo slide",
        "AI tạo hình ảnh",
  ...
  "youtubeVideos": [
    {
      ...
      "duration": "24:15",
      "date": "06/03/2026",
      "thumbnail": "https://i.ytimg.com/vi/e_4fU1hMh2U/hqdefault.jpg",
    ...
    },
    {
      ...
      "duration": "19:20",
      "date": "26/02/2026",
      "thumbnail": "https://i.ytimg.com/vi/yV3d0c3oY94/hqdefault.jpg",
    ...
    },
    {
      ...
      "duration": "22:05",
      "date": "15/02/2026",
      "thumbnail": "https://i.ytimg.com/vi/_2LLXnUdUIc/hqdefault.jpg",
    ...
    },
    {
      ...
      "duration": "27:45",
      "date": "10/02/2026",
      "thumbnail": "https://i.ytimg.com/vi/AQqIZ47p7W8/hqdefault.jpg",
    ...
    },
    {
      ...
      "duration": "25:30",
      "date": "05/02/2026",
      "thumbnail": "https://i.ytimg.com/vi/r2GAf_xGvjA/hqdefault.jpg",
      "category": "Online Business",
...
async function loadAppData() {
  try {
    // Ưu tiên gọi REST API kết nối MongoDB
    const apiResponse = await fetch('/api/db');
    if (apiResponse.ok) {
      const apiData = await apiResponse.json();
      if (apiData && !apiData.error) {
        return Object.assign({}, APP_DATA, apiData);
      }
    }
  } catch (err) {
    // API endpoint chưa sẵn sàng hoặc offline
  }

  try {
    // Fallback tải tệp tĩnh db.json
